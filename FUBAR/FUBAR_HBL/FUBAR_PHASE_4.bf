...
fubar_results = reportSiteResults   (sites, 0);
...
WriteSeparatedTable (results_file, {{"Codon","alpha","beta","beta-alpha","Prob[alpha<beta]", "Prob[alpha>beta]", "PSRF", "Neff", "FDR"}}, fubar_results, site_counter, ",");
